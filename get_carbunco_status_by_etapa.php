...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.vh_carbunco_tagid) AS vaccinated_animals
        FROM vacuno v
        LEFT JOIN vh_carbunco a ON v.tagid = a.vh_carbunco_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN vh_carbunco a ON v.tagid = a.vh_carbunco_tagid
        WHERE v.etapa IN ('Inicio', 'Crecimiento', 'Finalizacion') 
          AND a.vh_carbunco_tagid IS NULL
    ...
    error_log("Error fetching Carbunco status by etapa: " . $e->getMessage());
