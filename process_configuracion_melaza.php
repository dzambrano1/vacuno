...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO vc_melaza (vc_melaza_nombre, vc_melaza_etapa, vc_melaza_racion, vc_melaza_costo, vc_melaza_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE vc_melaza 
                    SET vc_melaza_nombre = :melaza, 
                        vc_melaza_etapa = :etapa,
                        vc_melaza_racion = :racion, 
                        vc_melaza_costo = :costo, 
                        vc_melaza_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM vc_melaza WHERE id = :id";
