...
if (isset($_POST['action'])) {
    ...
    try {
        ...
        if ($action === 'insert') {
            ...
            // Execute query
            $stmt = $conn->prepare("INSERT INTO vh_leche (vh_leche_tagid, vh_leche_peso, vh_leche_precio, vh_leche_fecha_inicio) VALUES (?, ?, ?, ?)");
        ...
        // UPDATE operation
            ...
            // Execute query
            $stmt = $conn->prepare("UPDATE vh_leche SET vh_leche_tagid = ?, vh_leche_peso = ?, vh_leche_precio = ?, vh_leche_fecha_inicio = ? WHERE id = ?");
