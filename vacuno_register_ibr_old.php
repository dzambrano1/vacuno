...
<title>Vacuno Register Ibr</title>
<!-- Link to the Favicon -->
                  ...
                  try {
                      $ibrQuery = "SELECT 
                                      ...
                                      FROM 
                                          vacuno v
                                      LEFT JOIN 
                                          -- Join with the latest ibr record per tagid
                                          vh_ibr va ON v.tagid = va.vh_ibr_tagid 
                                          AND va.id = (
                                              SELECT MAX(va_inner.id) 
                                              FROM vh_ibr va_inner 
                                              WHERE va_inner.vh_ibr_tagid = v.tagid
                                          )
                                      ORDER BY 
                                          in_ibr_history DESC, v.nombre ASC;";
                      ...
                      if (empty($ibrsData)) {
                          ...
                          foreach ($ibrsData as $row) {
                              ...
                              echo '        <button class="btn btn-success btn-sm add-ibr-btn" 
                              ...
                              if ($row['in_ibr_history'] == 1) {
                                  echo '        <button class="btn btn-warning btn-sm edit-ibr" 
                                  ...
                                  echo '        <button class="btn btn-danger btn-sm delete-ibr" 
                                                  data-id="' . htmlspecialchars($row['ibr_record_id'] ?? '') . '"
...
$(document).ready(function() {
    ...
    newEntryModalEl.addEventListener('show.bs.modal', function (event) {
        ...
        var modalForm = newEntryModalEl.querySelector('#newIbrForm'); // Updated form ID reference
...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-success text-white">
            <h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Evolución Dosis Ibr</h5>
        </div>
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
...
<!-- Pie Chart Section -->
<div class="container mt-5 mb-5">
    <h4 class="text-center text-black mb-4">Estado de Vacunación Ibr por Etapa</h4>
    <div class="row justify-content-center">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="ibrPieInicio"></canvas>
                        <div id="ibrPieInicioMessage" class="text-center small text-muted mt-2"></div>
                    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="ibrPieCrecimiento"></canvas>
                        <div id="ibrPieCrecimientoMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                    <div class="text-center mt-2">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="ibrPieFinalizacion"></canvas>
                         <div id="ibrPieFinalizacionMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                     <div class="text-center mt-2">
...
<script>
$(document).ready(function() {
    const ibrStatusUrl = 'get_ibr_status_by_etapa.php';
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.error) {
                console.error('Error fetching ibr status data:', data.error);
                 $('#ibrPieInicioMessage, #ibrPieCrecimientoMessage, #ibrPieFinalizacionMessage').text('Error al cargar datos.');
                return;
            }
            ...
            stages.forEach(stage => {
                 ...
                 const canvasId = `ibrPie${stage}`;
                 const messageId = `ibrPie${stage}Message`;
        ...
        error: function(xhr, status, error) {
            ...
            $('#ibrPieInicioMessage, #ibrPieCrecimientoMessage, #ibrPieFinalizacionMessage').text('Error de conexión al cargar datos.');
        }
    });
