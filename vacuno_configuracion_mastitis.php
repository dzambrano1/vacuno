...
<title>Vacuno Configuracion Mastitis</title>
<!-- Link to the Favicon -->
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="d-flex justify-content-center">
                <div class="arrow-step arrow-step-active w-100" style="border-radius: 15px; clip-path: none;">
                    <span class="badge-active">🎯 Estás configurando Mastitis</span>
...
<!-- New Entry Modal Configuracion Mastitis -->

<!-- Add New Vacuna Mastitis Button -->
      ...
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="newEntryModalLabel">
                  <i class="fas fa-plus-circle me-2"></i>Configurar Nueva Vacuna Mastitis
              </h5>
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="mastitisTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $mastitisQuery = "SELECT * FROM vc_mastitis";
                      ...
                      if (empty($mastitissData)) {
                          ...
                          foreach ($mastitissData as $row) {
                              ...
                              echo '        <button class="btn btn-warning edit-mastitis" style="height: 40px !important; width: 40px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                              data-id="' . htmlspecialchars($row['id'] ?? '') . '" 
                                              data-vacuna="' . htmlspecialchars($row['vc_mastitis_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['vc_mastitis_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['vc_mastitis_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['vc_mastitis_vigencia'] ?? '') . '"
                                              title="Editar Configuracion Vacuna Mastitis">
                                              <i class="fas fa-edit"></i>
                                          </button>';
                              echo '        <button class="btn btn-danger delete-mastitis" style="height: 40px !important; width: 40px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                              data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                              title="Eliminar Configuracion Vacuna Mastitis">
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['vc_mastitis_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['vc_mastitis_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['vc_mastitis_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['vc_mastitis_vigencia'] ?? 'N/A') . "</td>";
...
$(document).ready(function() {
    ...
    $('#saveNewMastitis').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Desea registrar la dosis de mastitis ${formData.dosis} ml ?`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: 'process_configuracion_mastitis.php',
                    type: 'POST',
                    data: {
                        action: 'insert',
    ...
    $('.edit-mastitis').click(function() {
        ...
        // Edit Configuracion Mastitis Modal dialog for editing
        var modalHtml = `
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editMastitisModalLabel">
                            <i class="fas fa-weight me-2"></i>Editar Vacuna Mastitis
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        $('#saveEditMastitis').click(function() {
            ...
            Swal.fire({
                ...
                text: `¿Desea actualizar la configuracion de mastitis?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#28a745',
                cancelButtonColor: '#dc3545',
    ...
    $('.delete-mastitis').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Está seguro de que desea eliminar la configuracion de mastitis? Esta acción no se puede deshacer.`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#dc3545',
