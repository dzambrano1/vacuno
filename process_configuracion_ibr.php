...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO vc_ibr (vc_ibr_vacuna, vc_ibr_dosis, vc_ibr_costo, vc_ibr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE vc_ibr 
                    SET vc_ibr_vacuna = :vacuna, 
                        vc_ibr_dosis = :dosis, 
                        vc_ibr_costo = :costo, 
                        vc_ibr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM vc_ibr WHERE id = :id";
