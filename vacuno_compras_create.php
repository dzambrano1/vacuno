...
try {
    ...
    $requiredFields = ['tagid', 'nombre', 'fecha_nacimiento', 'genero', 'raza', 'etapa', 'grupo', 'estatus', 'peso', 'precio'];
    $missingFields = [];
    ...
    $sql = "INSERT INTO vacuno (
                tagid, nombre, fecha_nacimiento, fecha_compra, genero,
                raza, etapa, grupo, estatus, peso_compra, precio_compra,
    ...
    $stmt->bindParam(':peso_compra', $_POST['peso']);
    $stmt->bindParam(':precio_compra', $_POST['precio']);
