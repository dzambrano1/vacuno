...
<title>Vacuno Register Aftosa</title>
<!-- Link to the Favicon -->
                  ...
                  try {
                      $aftosaQuery = "SELECT 
                                      ...
                                      FROM 
                                          vacuno v
                                      LEFT JOIN 
                                          -- Join with the latest aftosa record per tagid
                                          vh_aftosa va ON v.tagid = va.vh_aftosa_tagid 
                                          AND va.id = (
                                              SELECT MAX(va_inner.id) 
                                              FROM vh_aftosa va_inner 
                                              WHERE va_inner.vh_aftosa_tagid = v.tagid
                                          )
                                      ORDER BY 
                                          in_aftosa_history DESC, v.nombre ASC;";
                      ...
                      if (empty($aftosasData)) {
                          ...
                          foreach ($aftosasData as $row) {
                              ...
                              echo '        <button class="btn btn-success btn-sm register-new-aftosa-btn" 
                              ...
                              if ($row['in_aftosa_history'] == 1) {
                                  echo '        <button class="btn btn-warning btn-sm edit-aftosa" 
                                  ...
                                  echo '        <button class="btn btn-danger btn-sm delete-aftosa" 
                                                  data-id="' . htmlspecialchars($row['aftosa_record_id'] ?? '') . '"
...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-success text-white">
            <h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Evolución Dosis Aftosa</h5>
        </div>
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
...
<!-- Pie Chart Section -->
<div class="container mt-5 mb-5">
    <h4 class="text-center text-black mb-4">Estado de Vacunación Aftosa por Etapa</h4>
    <div class="row justify-content-center">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="aftosaPieInicio"></canvas>
                        <div id="aftosaPieInicioMessage" class="text-center small text-muted mt-2"></div>
                    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="aftosaPieCrecimiento"></canvas>
                        <div id="aftosaPieCrecimientoMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                    <div class="text-center mt-2">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="aftosaPieFinalizacion"></canvas>
                         <div id="aftosaPieFinalizacionMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                     <div class="text-center mt-2">
...
<script>
$(document).ready(function() {
    const aftosaStatusUrl = 'get_aftosa_status_by_etapa.php';
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.error) {
                console.error('Error fetching aftosa status data:', data.error);
                 $('#aftosaPieInicioMessage, #aftosaPieCrecimientoMessage, #aftosaPieFinalizacionMessage').text('Error al cargar datos.');
                return;
            }
            ...
            stages.forEach(stage => {
                 ...
                 const canvasId = `aftosaPie${stage}`;
                 const messageId = `aftosaPie${stage}Message`;
        ...
        error: function(xhr, status, error) {
            ...
            $('#aftosaPieInicioMessage, #aftosaPieCrecimientoMessage, #aftosaPieFinalizacionMessage').text('Error de conexión al cargar datos.');
        }
    });
