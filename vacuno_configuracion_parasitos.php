...
<title>Vacuno Configuracion Parasitos</title>
<!-- Link to the Favicon -->
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="d-flex justify-content-center">
                <div class="arrow-step arrow-step-active w-100" style="border-radius: 15px; clip-path: none;">
                    <span class="badge-active">🎯 Estás Configurando Parasitos</span>
...
<!-- New Entry Modal Configuracion Parasitos -->

<!-- Add New Vacuna Parasitos Button -->
<div class="container my-3 text-center">
  <button type="button" class="btn btn-success text-center" data-bs-toggle="modal" data-bs-target="#newEntryModal">
    <i class="fas fa-plus-circle me-2"></i>Nueva Vacuna Parasitos
  </button>
</div>
      ...
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="newEntryModalLabel">
                  <i class="fas fa-plus-circle me-2"></i>Configurar Nueva Vacuna Parasitos
              </h5>
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="parasitosTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $parasitosQuery = "SELECT * FROM vc_parasitos";
                      ...
                      if (empty($parasitossData)) {
                          ...
                          foreach ($parasitossData as $row) {
                              ...
                              echo '        <button class="btn btn-warning edit-parasitos" style="height: 40px !important; width: 40px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                              data-id="' . htmlspecialchars($row['id'] ?? '') . '" 
                                              data-vacuna="' . htmlspecialchars($row['vc_parasitos_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['vc_parasitos_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['vc_parasitos_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['vc_parasitos_vigencia'] ?? '') . '"
                                              title="Editar Configuracion Vacuna Parasitos">
                                              <i class="fas fa-edit"></i>
                                          </button>';
                              echo '        <button class="btn btn-danger delete-parasitos" style="height: 40px !important; width: 40px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                              data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                              title="Eliminar Configuracion Vacuna Parasitos">
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['vc_parasitos_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['vc_parasitos_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['vc_parasitos_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['vc_parasitos_vigencia'] ?? 'N/A') . "</td>";
...
$(document).ready(function() {
    ...
    $('#saveNewParasitos').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Desea registrar la dosis de parasitos ${formData.dosis} ml ?`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: 'process_configuracion_parasitos.php',
                    type: 'POST',
                    data: {
                        action: 'insert',
    ...
    $('.edit-parasitos').click(function() {
        ...
        // Edit Configuracion Parasitos Modal dialog for editing
        var modalHtml = `
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editParasitosModalLabel">
                            <i class="fas fa-weight me-2"></i>Editar Vacuna Parasitos
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        $('#saveEditParasitos').click(function() {
            ...
            Swal.fire({
                ...
                text: `¿Desea actualizar la configuracion de parasitos?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#28a745',
                cancelButtonColor: '#dc3545',
    ...
    $('.delete-parasitos').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Está seguro de que desea eliminar la configuracion de parasitos? Esta acción no se puede deshacer.`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#dc3545',
