...
<title>Vacuno Register Parasitos</title>
<!-- Link to the Favicon -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEntryModalLabel">
                    <i class="fas fa-plus-circle me-2"></i>Nuevo Tratamiento Parasitos
                </h5>
                  ...
                  try {
                      $parasitosQuery = "SELECT 
                                      ...
                                      FROM 
                                          vacuno v
                                      LEFT JOIN 
                                          -- Join with the latest parasitos record per tagid
                                          vh_parasitos va ON v.tagid = va.vh_parasitos_tagid 
                                          AND va.id = (
                                              SELECT MAX(va_inner.id) 
                                              FROM vh_parasitos va_inner 
                                              WHERE va_inner.vh_parasitos_tagid = v.tagid
                                          )
                                      ORDER BY 
                                          in_parasitos_history DESC, v.nombre ASC;";
                      ...
                      if (empty($parasitossData)) {
                          ...
                          foreach ($parasitossData as $row) {
                              ...
                              echo '        <button class="btn btn-success btn-sm add-parasitos-btn" 
                              ...
                              if ($row['in_parasitos_history'] == 1) {
                                  echo '        <button class="btn btn-warning btn-sm edit-parasitos" 
                                  ...
                                  echo '        <button class="btn btn-danger btn-sm delete-parasitos" 
                                                  data-id="' . htmlspecialchars($row['parasitos_record_id'] ?? '') . '"
...
$(document).ready(function() {
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editParasitosModalLabel">
                            <i class="fas fa-weight me-2"></i>Editar Tratamiento Parasitos
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
    ...
    $('.delete-parasitos').click(function() {
        var id = $(this).data('id');
        var tagid = $(this).data('tagid'); // Use data-tagid from the button
    ...
    newEntryModalEl.addEventListener('show.bs.modal', function (event) {
        ...
        var modalForm = newEntryModalEl.querySelector('#newParasitosForm'); // Correct form ID
    ...
    // Removed the old .register-new-parasitos click listener
});
</script>
...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-success text-white">
            <h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Evolución Dosis Parasitos</h5>
        </div>
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
...
<!-- Pie Chart Section -->
<div class="container mt-5 mb-5">
    <h4 class="text-center text-black mb-4">Estado de Vacunación Parasitos por Etapa</h4>
    <div class="row justify-content-center">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="parasitosPieInicio"></canvas>
                        <div id="parasitosPieInicioMessage" class="text-center small text-muted mt-2"></div>
                    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="parasitosPieCrecimiento"></canvas>
                        <div id="parasitosPieCrecimientoMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                    <div class="text-center mt-2">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="parasitosPieFinalizacion"></canvas>
                         <div id="parasitosPieFinalizacionMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                     <div class="text-center mt-2">
...
<script>
$(document).ready(function() {
    const parasitosStatusUrl = 'get_parasitos_status_by_etapa.php';
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.error) {
                console.error('Error fetching parasitos status data:', data.error);
                 $('#parasitosPieInicioMessage, #parasitosPieCrecimientoMessage, #parasitosPieFinalizacionMessage').text('Error al cargar datos.');
                return;
            }
            ...
            stages.forEach(stage => {
                 ...
                 const canvasId = `parasitosPie${stage}`;
                 const messageId = `parasitosPie${stage}Message`;
        ...
        error: function(xhr, status, error) {
            ...
            $('#parasitosPieInicioMessage, #parasitosPieCrecimientoMessage, #parasitosPieFinalizacionMessage').text('Error de conexión al cargar datos.');
        }
    });
