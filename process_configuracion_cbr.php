...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO vc_cbr (vc_cbr_vacuna, vc_cbr_dosis, vc_cbr_costo, vc_cbr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE vc_cbr 
                    SET vc_cbr_vacuna = :vacuna, 
                        vc_cbr_dosis = :dosis, 
                        vc_cbr_costo = :costo, 
                        vc_cbr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM vc_cbr WHERE id = :id";
