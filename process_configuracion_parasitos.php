...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO vc_parasitos (vc_parasitos_vacuna, vc_parasitos_dosis, vc_parasitos_costo, vc_parasitos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE vc_parasitos 
                    SET vc_parasitos_vacuna = :vacuna, 
                        vc_parasitos_dosis = :dosis, 
                        vc_parasitos_costo = :costo, 
                        vc_parasitos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM vc_parasitos WHERE id = :id";
