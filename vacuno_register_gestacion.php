...
$chartData = [];
try {
    $chartQuery = "SELECT DATE_FORMAT(vh_gestacion_fecha, '%Y-%m') as month_year, COUNT(*) as count 
                     FROM vh_gestacion 
                     GROUP BY month_year 
...
<title>Vacuno Register Gestacion</title>
<!-- Link to the Favicon -->
                  ...
                  try {
                      // Query to get all Female animals and their LATEST gestacion record (if any)
                        $gestacionQuery = "
                            SELECT
                                ...
                                ins.vh_gestacion_fecha,
                                ins.vh_gestacion_tagid, -- Will be NULL if no gestacion
                                ins.vh_gestacion_numero
                            FROM
                                vacuno v
                            LEFT JOIN vh_gestacion ins
                              ON v.tagid = ins.vh_gestacion_tagid
                            LEFT JOIN vh_gestacion ins_check
                              ON ins.vh_gestacion_tagid = ins_check.vh_gestacion_tagid
                             AND ins.vh_gestacion_fecha < ins_check.vh_gestacion_fecha -- Check for a newer record
                            ...
                            ORDER BY
                                ...
                                ins.vh_gestacion_fecha DESC, -- Then by latest insemination date
                      ...
                      if (empty($gestacionData)) {
                          ...
                          foreach ($gestacionData as $row) {
                              ...
                              $gestacionFecha = $row['vh_gestacion_fecha'] ?? null;
                              ...
                              echo "<td class='text-center'>" . ($hasgestacion ? htmlspecialchars($row['vh_gestacion_numero'] ?? '') : 'N/A') . "</td>";                              
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-success register-new-gestacion-btn" style="height: 30px !important; width: 30px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                      ...
                                      <button class="btn btn-warning edit-gestacion" style="height: 30px !important; width: 30px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                      ...
                                      <button class="btn btn-danger delete-gestacion" style="height: 30px !important; width: 30px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                          data-id="'.htmlspecialchars($row['gestacion_id'] ?? '').'" 
                                          data-tagid="'.htmlspecialchars($row['vacuno_tagid'] ?? '').'" 
