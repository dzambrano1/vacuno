...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.vh_cbr_tagid) AS vaccinated_animals
        FROM vacuno v
        LEFT JOIN vh_cbr a ON v.tagid = a.vh_cbr_tagid
    ...
    error_log("Error fetching CBR status by etapa: " . $e->getMessage());
