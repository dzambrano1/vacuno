...
<title>Vacuno - Registro de Vacunación Carbunco</title>
<!-- Link to the Favicon -->
            ...
            <div class="row justify-content-center align-items-stretch">
                ...
                <div class="col-md-4 d-flex px-1 mb-3 mb-md-0">
                    <div class="arrow-step arrow-step-active w-100">
                        <span class="badge-active">🎯 Registrando Vacuna Carbunco</span>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEntryModalLabel">
                    <i class="fas fa-plus-circle me-2"></i>Nueva Vacunacion Carbunco
                </h5>
                    ...
                    <div class="mb-4">                        
                        <div class="input-group">
                            <span class="input-group-text">
                                ...
                                <label for="new_vacuna" class="form-label">Vacunas Carbunco</label>
                                <select class="form-select" id="new_vacuna" name="vacuna" required>
                                    <option value="">Vacunas</option>
                                    <?php
                                    try {
                                        $sql_vacunas = "SELECT DISTINCT vc_carbunco_vacuna FROM vc_carbunco ORDER BY vc_carbunco_vacuna ASC";
                                        ...
                                        foreach ($vacunas as $vacuna_row) {
                                            echo '<option value="' . htmlspecialchars($vacuna_row['vc_carbunco_vacuna']) . '">' . htmlspecialchars($vacuna_row['vc_carbunco_vacuna']) . '</option>';
                                        }
      ...
      <div class="table-responsive">
          <table id="carbuncoTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                  try {
                      $carbuncoQuery = "SELECT 
                                          v.id AS vacuno_id, -- Alias vacuno ID
                                          v.tagid,
                                          v.nombre,
                                          va.vh_carbunco_fecha,
                                          va.id AS carbunco_record_id, -- Alias carbunco record ID
                                          va.vh_carbunco_producto,
                                          va.vh_carbunco_dosis,
                                          va.vh_carbunco_costo,
                                          -- Flag to easily check if there's a history record
                                          CASE WHEN va.vh_carbunco_tagid IS NOT NULL THEN 1 ELSE 0 END AS in_carbunco_history
                                      FROM 
                                          vacuno v
                                      LEFT JOIN 
                                          -- Join with all carbunco records per tagid
                                          vh_carbunco va ON v.tagid = va.vh_carbunco_tagid 
                                      ORDER BY 
                                          va.vh_carbunco_fecha DESC, v.tagid ASC;";
                      ...
                      if (empty($carbuncosData)) {
                          ...
                          try {
                              ...
                              if ($row_config && isset($row_config['v_vencimiento_carbunco'])) {
                                  $vigencia = intval($row_config['v_vencimiento_carbunco']);
                              }
                          } catch (PDOException $e) {
                          ...
                          foreach ($carbuncosData as $row) {
                              ...
                              if ($row['in_carbunco_history'] == 1) {
                                  // Animal has vaccination history
                                  echo "<td>" . htmlspecialchars($row['vh_carbunco_producto'] ?? 'N/A') . "</td>";
                                  echo "<td>" . htmlspecialchars($row['vh_carbunco_dosis'] ?? 'N/A') . "</td>";
                                  echo "<td>" . htmlspecialchars($row['vh_carbunco_costo'] ?? 'N/A') . "</td>";

                                  // Calculate due date and determine status
                                  try {
                                      if (!empty($row['vh_carbunco_fecha'])) {
                              ...
                              echo '        <button class="btn btn-success register-new-carbunco-btn" style="height: 30px !important; width: 30px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                              ...
                              if ($row['in_carbunco_history'] == 1) {
                                  echo '        <button class="btn btn-warning edit-carbunco" style="height: 30px !important; width: 30px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                                  data-id="' . htmlspecialchars($row['carbunco_record_id'] ?? '') . '" 
                                  ...
                                  echo '        <button class="btn btn-danger delete-carbunco" style="height: 30px !important; width: 30px !important; padding: 0 !important; font-size: 1rem !important; line-height: 30px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;"
                                                  data-id="' . htmlspecialchars($row['carbunco_record_id'] ?? '') . '"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editCarbuncoModalLabel">
                            <i class="fas fa-weight me-2"></i>Editar Vacunacion Carbunco
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="editCarbuncoForm">
                            ...
                            <div class="mb-4">                        
                                <div class="input-group">
                                    <span class="input-group-text">
                                        <i class="fa-solid fa-syringe"></i>
                                        <label for="edit_vacuna" class="form-label">Vacunas Carbunco</label>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="vacunaSelectionModalLabel">
                            <i class="fas fa-list me-2"></i>Seleccionar Vacuna de Carbunco
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="list-group" id="vacunaList" style="max-height: 300px; overflow-y: auto;">
                                ...
                                try {
                                    ...
                                    $vacunas = $stmt_vacunas->fetchAll(PDO::FETCH_ASSOC);
                                    foreach ($vacunas as $vacuna_row) {
                                        echo '<button type="button" class="list-group-item list-group-item-action vacuna-option" data-value="' . htmlspecialchars($vacuna_row['vc_carbunco_vacuna']) . '">' . htmlspecialchars($vacuna_row['vc_carbunco_vacuna']) . '</button>';
                                    }
                                } catch (PDOException $e) {
                                    error_log("Error fetching vacunas: " . $e->getMessage());
...
<!-- Professional CSS Styling for Carbunco Charts -->
<style>
...
<!-- Pie Chart Section -->
<div class="container mt-5 mb-5">
    <h4 class="text-center text-black mb-4">Estado de Vacunación Carbunco por Grupos</h4>
    <div class="row justify-content-center" id="groupChartsContainer">
        <!-- Group charts will be populated dynamically here -->
    </div>
</div>

<!-- Chart.js Script for Carbunco Status Pie Charts -->
<script>
$(document).ready(function() {
    const carbuncoStatusUrl = 'get_carbunco_status_by_grupo.php';
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="chart-container" style="position: relative; height:40vh; width:100%">
                            <canvas id="carbuncoPie${safeGrupo}"></canvas>
                            <div id="carbuncoPie${safeGrupo}Message" class="text-center small text-muted mt-2"></div>
                        </div>
    ...
    $.ajax({
        url: carbuncoStatusUrl,
        type: 'GET',
        dataType: 'json',
        success: function(data) {
            if (data.error) {
                console.error('Error fetching carbunco status data:', data.error);
            ...
            grupos.forEach(grupo => {
                ...
                const canvasId = `carbuncoPie${safeGrupo}`;
                const messageId = `carbuncoPie${safeGrupo}Message`;
        ...
        error: function(xhr, status, error) {
            console.error('AJAX error fetching carbunco status data:', error);
