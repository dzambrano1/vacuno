...
<title>Vacuno Register Carbunco</title>
<!-- Link to the Favicon -->
                  ...
                  try {
                      $carbuncoQuery = "SELECT 
                                      ...
                                      FROM 
                                          vacuno v
                                      LEFT JOIN 
                                          -- Join with the latest carbunco record per tagid
                                          vh_carbunco va ON v.tagid = va.vh_carbunco_tagid 
                                          AND va.id = (
                                              SELECT MAX(va_inner.id) 
                                              FROM vh_carbunco va_inner 
                                              WHERE va_inner.vh_carbunco_tagid = v.tagid
                                          )
                                      ORDER BY 
                                          in_carbunco_history DESC, v.nombre ASC;";
                      ...
                      if (empty($carbuncosData)) {
                          ...
                          foreach ($carbuncosData as $row) {
                              ...
                              echo '        <button class="btn btn-success btn-sm add-carbunco-btn" 
                              ...
                              if ($row['in_carbunco_history'] == 1) {
                                  echo '        <button class="btn btn-warning btn-sm edit-carbunco" 
                                  ...
                                  echo '        <button class="btn btn-danger btn-sm delete-carbunco" 
                                                  data-id="' . htmlspecialchars($row['carbunco_record_id'] ?? '') . '"
...
$(document).ready(function() {
    ...
    newEntryModalEl.addEventListener('show.bs.modal', function (event) {
        ...
        var modalForm = newEntryModalEl.querySelector('#newCarbuncoForm'); // Ensure correct form ID
...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-success text-white">
            <h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Evolución Dosis Carbunco</h5>
        </div>
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
...
<!-- Pie Chart Section -->
<div class="container mt-5 mb-5">
    <h4 class="text-center text-black mb-4">Estado de Vacunación Carbunco por Etapa</h4>
    <div class="row justify-content-center">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="carbuncoPieInicio"></canvas>
                        <div id="carbuncoPieInicioMessage" class="text-center small text-muted mt-2"></div>
                    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="carbuncoPieCrecimiento"></canvas>
                        <div id="carbuncoPieCrecimientoMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                    <div class="text-center mt-2">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="chart-container" style="position: relative; height:40vh; width:100%">
                        <canvas id="carbuncoPieFinalizacion"></canvas>
                         <div id="carbuncoPieFinalizacionMessage" class="text-center small text-muted mt-2"></div>
                    </div>
                     <!-- Toggle Button and Table for Non-Vaccinated -->
                     <div class="text-center mt-2">
...
<script>
$(document).ready(function() {
    const carbuncoStatusUrl = 'get_carbunco_status_by_etapa.php';
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.error) {
                console.error('Error fetching carbunco status data:', data.error);
                 $('#carbuncoPieInicioMessage, #carbuncoPieCrecimientoMessage, #carbuncoPieFinalizacionMessage').text('Error al cargar datos.');
                return;
            }
            ...
            stages.forEach(stage => {
                 ...
                 const canvasId = `carbuncoPie${stage}`;
                 const messageId = `carbuncoPie${stage}Message`;
        ...
        error: function(xhr, status, error) {
            ...
            $('#carbuncoPieInicioMessage, #carbuncoPieCrecimientoMessage, #carbuncoPieFinalizacionMessage').text('Error de conexión al cargar datos.');
        }
    });
