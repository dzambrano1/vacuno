...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.vh_parasitos_tagid) AS vaccinated_animals
        FROM vacuno v
        LEFT JOIN vh_parasitos a ON v.tagid = a.vh_parasitos_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN vh_parasitos a ON v.tagid = a.vh_parasitos_tagid
        WHERE v.grupo IS NOT NULL AND v.grupo != ''
          AND a.vh_parasitos_tagid IS NULL
    ...
    error_log("Error fetching Parasitos status by grupo: " . $e->getMessage());
