...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO vc_brucelosis (vc_brucelosis_vacuna, vc_brucelosis_dosis, vc_brucelosis_costo, vc_brucelosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE vc_brucelosis 
                    SET vc_brucelosis_vacuna = :vacuna, 
                        vc_brucelosis_dosis = :dosis, 
                        vc_brucelosis_costo = :costo, 
                        vc_brucelosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM vc_brucelosis WHERE id = :id";
