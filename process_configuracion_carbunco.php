...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO vc_carbunco (vc_carbunco_vacuna, vc_carbunco_dosis, vc_carbunco_costo, vc_carbunco_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE vc_carbunco 
                    SET vc_carbunco_vacuna = :vacuna, 
                        vc_carbunco_dosis = :dosis, 
                        vc_carbunco_costo = :costo, 
                        vc_carbunco_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM vc_carbunco WHERE id = :id";
