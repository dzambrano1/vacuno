...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.vh_garrapatas_tagid) AS vaccinated_animals
        FROM vacuno v
        LEFT JOIN vh_garrapatas a ON v.tagid = a.vh_garrapatas_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN vh_garrapatas a ON v.tagid = a.vh_garrapatas_tagid
        WHERE v.grupo IS NOT NULL AND v.grupo != ''
          AND a.vh_garrapatas_tagid IS NULL
    ...
    error_log("Error fetching Garrapatas status by grupo: " . $e->getMessage());
